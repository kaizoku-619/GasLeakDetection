package com.iot4all.gasleakdetection;
    ...
    public void updateView(String sensorMessage) {
        try {
            SharedPreferences sharedPref = getSharedPreferences(
                    "com.iot4all.gassensorapp.PREFERENCE_FILE_KEY",
                    Context.MODE_PRIVATE);
            if (sensorMessage == null || sensorMessage == "") {
                sensorMessage = sharedPref.getString("lastSensorMessage", "No Gas Detected");
            }
    ...
    public void createNotification(String notificationTitle,
        ...
        NotificationCompat.Builder mBuilder =
                new NotificationCompat.Builder(getApplicationContext())
                        .setSmallIcon(R.drawable.gas_detection_icon2)
